    ...
    <a className="text-white group" href={href} target="_blank">
      <div
        className={classNames(
          ...
          {
            "bg-green-glass group-hover:bg-green-33 group-hover:text-darkblue-900":
              isDarkModeEnabled,
            "bg-darkblue-glass group-hover:bg-darkblue-900 text-darkblue-900 group-hover:text-white":
              !isDarkModeEnabled,
          }
        )}
      >
